...
import 'package:app_food/screens/auth/login_screen.dart';
import 'package:app_food/screens/auth/signup_screen.dart';
...
class CenterNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding:
          EdgeInsets.only(bottom: 25 + MediaQuery.of(context).padding.bottom),
      child: Column(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(
                        10 + 32 * (1 - _signUpMoveAnimation.value)),
